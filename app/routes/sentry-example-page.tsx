    ...
    <div>
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" rel="noreferrer" href="https://dev-sentry.spanllc.com/organizations/sentry/issues/?project=27">Issues Page</a>. 
